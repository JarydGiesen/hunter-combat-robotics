        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-[#0D172B]/80 mb-8 leading-relaxed font-semibold">
              The best part? You don't need any prior experience to get started. Our community 
              welcomes complete beginners and provides all the guidance you need to build your first robot.
            </p>
            ...
            <div className="grid grid-cols-3 gap-6 text-center">
              <div className="border border-accent-orange/30 p-4">
                ...
                <div className="text-sm text-[#0D172B]/70 uppercase tracking-wide">Robots Built</div>
              </div>
              <div className="border border-accent-cyan/30 p-4">
                <div className="text-3xl font-black text-accent-cyan mb-2">500+</div>
                <div className="text-sm text-[#0D172B]/70 uppercase tracking-wide">Matches Fought</div>
              </div>
              <div className="border border-accent-purple/30 p-4">
                <div className="text-3xl font-black text-accent-purple mb-2">75+</div>
                <div className="text-sm text-[#0D172B]/70 uppercase tracking-wide">Active Builders</div>
              </div>
            </div>
